...
from memory.vector_store import get_fact, process_memory
from learning.behavior import analyze_interaction, build_behavior_context

from tools.system_control import run_system_command
...
def jarvis_voice():
    ...
    while True:
        ...
        tool_reply = run_system_command(user_input)

        if tool_reply:
            print("Jarvis:", tool_reply)
            speak(tool_reply)
            continue
